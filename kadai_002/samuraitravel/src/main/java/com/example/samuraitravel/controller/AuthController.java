...
public class AuthController {    
    ...
    public AuthController(UserService userService, Optional<SignupEventPublisher> signupEventPublisher, VerificationTokenService verificationTokenService) { // optionalに変更
        this.userService = userService; 
        this.signupEventPublisher = signupEventPublisher.orElse(null);
